...
Just fork the repo and adjust the `_config.yml` to use with [Github Pages](https://pages.github.com/) and your page is done. Read more about [Jekyll](https://jekyllrb.com/).
