...
- demonstrated the use to Cellpose on another user's fluorescence microcopy images, where cells were clustering together. Cellpose did an excellent job identifing cells in not only areas where there were few cells, but also in areas where cells were clustering together.
