...
- Keep clicking next button until you reach the *Select a tracker* option. Select *Simple LAP tracker* and click next.  
...
- Keep clicking next until you reach the *Display options*. Here, various display options fir the tracks could be selected. Choose *Show tracks backward in time*.  
