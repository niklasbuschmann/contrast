...
- Keep clicking next until you reach the last window called *Select an action* (image D below). Select *Capture overlay* and click *Execute* to generate a time-lapse movie with spots and tracks overlaid on top of the original data.  
...
| A | B | C | D |
| - | - | - | - | 
| ![](seminar_workkshop/TrackMate_detector.png) | ![](seminar_workkshop/TrackMate_tracker.png) | ![](seminar_workkshop/TrackMate_displayOptions.png) | ![](seminar_workkshop/TrackMate_generateOverlay.png) |
